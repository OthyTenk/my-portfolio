      ...
      <div className="items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
        <div className="flex flex-col items-center pt-8">
          ...
          <div className="flex space-x-5 pt-6">
            <a href={profile[0].socialLinks.github} target="_blank">
              <svg
            ...
            <a href={profile[0].socialLinks.linkedin} target="_blank">
              <svg
                viewBox="0 0 1024 1024"
                fill="currentColor"
                className="w-8 h-8 text-orange-500 hover:text-orange-600"
            ...
            <a href={`mailto:${profile[0].email}`} target="_blank">
              <svg
                viewBox="0 0 1024 1024"
                fill="currentColor"
                className="w-8 h-8 text-orange-500 hover:text-orange-600"
            ...
            <a href={profile[0].socialLinks.twitter} target="_blank">
              <svg
                viewBox="0 0 1024 1024"
                fill="currentColor"
                className="w-8 h-8 text-orange-500 hover:text-orange-600"
